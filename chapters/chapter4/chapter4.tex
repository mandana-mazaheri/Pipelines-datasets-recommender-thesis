...
It should be noted that the experts were supposed to predict the compatibility of a given dataset and pipeline and not to what extent they are relevant which might lead to priming or evaluation bias~\cite{victorino2019priming}.
...
\begin{figure}
  \includegraphics[width=\columnwidth]{figures/Confidence Grouped Bar Experts.pdf}
