...
The first step for publishing the tool/pipeline is to describe a command line
...
that inter-operates with other platforms such as Zenodo and OSF along with a web graphical interface to build the DATS model is also available in that section, and 

can edit DATS.json and assigne to a dataset
